...
y = math.sin(DZ_longr-long1) * math.cos(DZ_latr)
x = math.cos(lat1) * math.sin(DZ_latr) - math.sin(lat1)*math.cos(DZ_latr)*math.cos(DZ_longr-long1)
brng = math.atan2(y, x)
theta = math.degrees(brng)
